...
(function (SoftScan) {
    // Enable SoftScan
    SoftScan[SoftScan["Enable"] = 0] = "Enable";
    // Disable SoftScan
    SoftScan[SoftScan["Disable"] = 1] = "Disable";
    // SoftScan is not supported, and cannot be enabled
    SoftScan[SoftScan["NotSupported"] = 2] = "NotSupported";
    // SoftScan is supported and can be enabled
    SoftScan[SoftScan["Supported"] = 2] = "Supported";
})(SoftScan || (SoftScan = {}));
;
...
(function (StandConfig) {
    ...
    StandConfig[StandConfig["MobileMode"] = 0] = "MobileMode";
    ...
    // retries forever
    StandConfig[StandConfig["StandMode"] = 1] = "StandMode";
    ...
    // count
    StandConfig[StandConfig["DetectMode"] = 2] = "DetectMode";
    ...
    StandConfig[StandConfig["AutoMode"] = 3] = "AutoMode";
})(StandConfig || (StandConfig = {}));
;
// The mask to apply for each button that is pressed
export var ButtonPressMask;
(function (ButtonPressMask) {
    // The left button is pressed.
    ButtonPressMask[ButtonPressMask["Left"] = 1] = "Left";
    // The right button is pressed.
    ButtonPressMask[ButtonPressMask["Right"] = 2] = "Right";
    // The middle button is pressed.
    ButtonPressMask[ButtonPressMask["Middle"] = 4] = "Middle";
    // The power button is pressed.
    ButtonPressMask[ButtonPressMask["Power"] = 8] = "Power";
    // The Ring is detached from the wrist unit.
    ButtonPressMask[ButtonPressMask["RingDetach"] = 16] = "RingDetach";
