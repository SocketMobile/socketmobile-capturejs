/* CaptureJS version 1.4.3.0 2025/11/17 18:28:01 © 2025 Socket Mobile, inc. */
...
/* harmony import */ var _captureEvents__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./captureEvents */ "./ts/captureEvents.ts");
    ...
    unifyResultInEvents(jsonRpc) {
        ...
        if (jsonRpc.result && JSON.stringify(jsonRpc.result) != '{}') {
            if (res.event) {
                ...
                if (value && res.event.type === _captureEvents__WEBPACK_IMPORTED_MODULE_2__.CaptureEventTypes.DecodedData) {
...
CaptureDataSourceID.LastSymbologyID = 51;
...
/* harmony import */ var _captureEvents__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./captureEvents */ "./ts/captureEvents.ts");
...
class HttpTransport extends _rpcTransport__WEBPACK_IMPORTED_MODULE_1__.BaseTransport {
    ...
    openWebSocket(callback) {
        ...
        this.websocket.onclose = event => {
            ...
            if (event.code === 1006) {
                const error = new _jsonRpc__WEBPACK_IMPORTED_MODULE_0__.JRpcEvent(_captureEvents__WEBPACK_IMPORTED_MODULE_3__.CaptureEventIds.Error, _captureEvents__WEBPACK_IMPORTED_MODULE_3__.CaptureEventTypes.Ulong, _gen_errors__WEBPACK_IMPORTED_MODULE_2__["default"].ESKT_SERVICENOTCOMMUNICATING);
...
class JRpcEvent {
    constructor(id, type, value, handle) {
        ...
        let res = id === _captureEvents__WEBPACK_IMPORTED_MODULE_0__.CaptureEventIds.Error ? value : 0;
...
class JRpcEventDevicePresence extends JRpcEvent {
    constructor(id, deviceInfo, handle) {
        super(id, _captureEvents__WEBPACK_IMPORTED_MODULE_0__.CaptureEventTypes.DeviceInfo, deviceInfo, handle);
    }
}
;
...
/* harmony export */   CaptureDataSourceFlags: () => (/* reexport safe */ _gen_dataSources__WEBPACK_IMPORTED_MODULE_7__.CaptureDataSourceFlags),
/* harmony export */   CaptureDataSourceID: () => (/* reexport safe */ _gen_dataSources__WEBPACK_IMPORTED_MODULE_7__.CaptureDataSourceID),
/* harmony export */   CaptureDataSourceStatus: () => (/* reexport safe */ _gen_dataSources__WEBPACK_IMPORTED_MODULE_7__.CaptureDataSourceStatus),
/* harmony export */   CaptureDeviceType: () => (/* reexport safe */ _gen_deviceTypes__WEBPACK_IMPORTED_MODULE_6__.CaptureDeviceType),
/* harmony export */   CaptureEvent: () => (/* reexport safe */ _captureEvents__WEBPACK_IMPORTED_MODULE_5__.CaptureEvent),
/* harmony export */   CaptureEventIds: () => (/* reexport safe */ _captureEvents__WEBPACK_IMPORTED_MODULE_5__.CaptureEventIds),
/* harmony export */   CaptureEventTypes: () => (/* reexport safe */ _captureEvents__WEBPACK_IMPORTED_MODULE_5__.CaptureEventTypes),
...
/* harmony export */   JRpcError: () => (/* reexport safe */ _jsonRpc__WEBPACK_IMPORTED_MODULE_8__.JRpcError),
/* harmony export */   JRpcResponse: () => (/* reexport safe */ _jsonRpc__WEBPACK_IMPORTED_MODULE_8__.JRpcResponse),
/* harmony export */   JsonRpc: () => (/* reexport safe */ _jsonRpc__WEBPACK_IMPORTED_MODULE_8__.JsonRpc),
...
/* harmony import */ var _captureEvents__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./captureEvents */ "./ts/captureEvents.ts");
/* harmony import */ var _gen_deviceTypes__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./gen/deviceTypes */ "./ts/gen/deviceTypes.ts");
/* harmony import */ var _gen_dataSources__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./gen/dataSources */ "./ts/gen/dataSources.ts");
/* harmony import */ var _jsonRpc__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./jsonRpc */ "./ts/jsonRpc.ts");
...
//# sourceMappingURL=captureJs-1.4.3.0.map